<div class="product full <?php echo $classes;?>">
	...
	<div class="infa-tabs tabinit">
		<div class="tabs-wrap">
			...
			<?php if (!empty($content['field_harakteristic'])):?>
				<div id='tovar-full-haract'>
					<div class="wrap "><?php echo render($content['field_harakteristic']);?></div>
				</div>
			<?php endif;?>
			<?php if (!empty($content['field_text'])):?>
				<div id='tovar-full-descr'>
					<div class="wrap clearfix"><?php echo render($content['field_text']);?></div>
				</div>
			<?php endif;?>
			<?php if (!empty($content['comments'])):?>
				<div id='tovar-full-otsivs'>
					<div class="wrap clearfix"><?php echo render($content['comments']);?></div>
				</div>
			<?php endif;?>
